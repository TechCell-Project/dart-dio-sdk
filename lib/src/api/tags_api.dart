...
import 'package:dart_dio_sdk/src/model/create_tag_dto.dart';
import 'package:dart_dio_sdk/src/model/tag.dart';
import 'package:dart_dio_sdk/src/model/tag_infinity_pagination_result.dart';
import 'package:dart_dio_sdk/src/model/update_tag_dto.dart';
...
class TagsApi {
  ...
  Future<Response<void>> tagsControllerCreateTag({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Tag>> tagsControllerGetTag({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [page] 
  /// * [limit] 
  /// * [filters] - JSON string of FilterTagDto
  /// * [sort] - JSON string of SortTagDto
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TagInfinityPaginationResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TagInfinityPaginationResult>> tagsControllerGetTags({ 
    num? page,
    num? limit,
    String? filters,
    String? sort,
    ...
    TagInfinityPaginationResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TagInfinityPaginationResult),
      ) as TagInfinityPaginationResult;
    ...
    return Response<TagInfinityPaginationResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> tagsControllerUpdateTag({ 
    required String id,
